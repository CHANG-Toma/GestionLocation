...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 27 fév. 2023 à 21:02
...
INSERT INTO `appartements` (`numappart`, `rue`, `ville`, `CP`, `etage`, `prix_log`, `prix_charg`, `ascenseur`, `preavis`, `date_libre`, `id_typeAppart`, `arrondissement_num`, `taille`) VALUES
(1, 123, 'Paris', 75000, 4, 500, 550, 1, 1, '2022-01-01', 1, '1', 30),
(2, 456, 'Lyon', 69000, 2, 600, 650, 0, 0, '2022-02-01', 2, '2', 40),
(3, 789, 'Marseille', 13000, 1, 700, 750, 1, 0, '2022-03-01', 3, '3', 75),
(4, 246, 'Lille', 59000, 5, 400, 450, 0, 1, '2022-04-01', 4, '4', 80),
(5, 369, 'Toulouse', 31000, 3, 800, 850, 1, 0, '2022-05-01', 5, '5', 0),
...
INSERT INTO `demandes` (`num_dem`, `num_cli`, `date_limite`, `prix_min`, `prix_max`, `taille`, `ville`) VALUES
(1, 2, '2022-05-01', 400, 700, 40, 'Nantes'),
(2, 4, '2022-06-01', 450, 950, 60, 'Bordeaux'),
(3, 7, '2022-07-01', 550, 600, 30, 'Nice'),
(4, 5, '2022-08-01', 800, 1200, 100, 'Paris'),
(5, 9, '2022-09-01', 500, 900, 80, 'Lyon'),
(6, 3, '2022-10-01', 700, 750, 50, 'Strasbourg'),
(7, 6, '2022-11-01', 450, 500, 30, 'Rennes'),
(8, 10, '2022-12-01', 650, 1000, 80, 'Marseille'),
(9, 1, '2023-01-01', 500, 700, 70, 'Toulouse'),
(10, 8, '2023-02-01', 600, 950, 75, 'Lille');
...
ALTER TABLE `appartements`
  ...
  ADD CONSTRAINT `appartements_ibfk_2` FOREIGN KEY (`arrondissement_num`) REFERENCES `arrondissement` (`arrondissement_num`);
...
ALTER TABLE `concerner`
  ADD CONSTRAINT `concerner_ibfk_1` FOREIGN KEY (`arrondissement_num`) REFERENCES `arrondissement` (`arrondissement_num`),
