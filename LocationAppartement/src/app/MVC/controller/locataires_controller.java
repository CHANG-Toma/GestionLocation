...
public class locataires_controller implements ActionListener{
    ...
    //////////CLIENT////////////
    private int id, idAppartements,cp,tel,RIB;  //id = idClient
    private String nom,prenom,adresse,ville,Datenaiss, dateVisite,mdp,Client;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        switch (e.getActionCommand()) {
            ...
            case "Ajouter locataire" ->{
                System.out.println(this.idAppartements);
            ...
            case "Ajouter visite"->{
                try {
                    this.menuView.setView("VueajouteVisite", null, this.id);   //setview (vue principale)
                } catch (Exception ex) {
                    throw new RuntimeException(ex);
                }

                System.out.println("Vue Ajouter visite");
            }

            case "Ajouter"->{
                try {
                    this.locataires_dao.addVisite(this.idAppartements, this.id,this.dateVisite);
    ...
    public void setIdCli(int id){this.id = id;} //idClient
    ...
    public void setIdAppartements(int idAppartements){this.idAppartements = idAppartements;}
    ...
    public ResultSet getIdAllAppart() throws Exception { //ville pour le champ de sélection
        ResultSet rs = this.appartement_dao.getAllAppartDispo(); //appelle la fonction du dao
        return rs;
    }
}