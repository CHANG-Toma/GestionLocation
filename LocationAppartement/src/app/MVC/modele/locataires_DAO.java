...
public class locataires_DAO {
    ...
    public void addVisite(int numApaprt, int idClient, String Date) throws Exception {
        connexionBDD l = new connexionBDD(); //connexion à la BDD
        ////////////////////SQL///////////////////////
        try {
            /* Requete SQL à executée */
            String req = "INSERT INTO `visiter`(`numappart`, `idClient`, `date_visite`) VALUES (?, ?, ?)";
            //prepare la requete
            PreparedStatement psReq = l.prepareReq(req);

            psReq.setInt(1, numApaprt);
