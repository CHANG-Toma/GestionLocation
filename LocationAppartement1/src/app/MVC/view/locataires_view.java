...
public class locataires_view extends JPanel{
    ...
    private JPanel panelLabel, panelLabel2,global;
    private JList<String> clients,appartements,Ville;

    ///////new client////////
    private JTextField nom,prenom,adresse,cp,tel,Datenaiss,RIB,mdp;
    ...
    public locataires_view(menu_view menu, ResultSet rs, int num) throws Exception {
        ...
        this.b3.addActionListener(e -> {
            ...
            locataires_controller.setAppart(appart);
        ...
        this.b4.addActionListener(e -> {
            try {
                if (num == 1){
                    int id = rs.getInt("id");
                    this.locataires_controller.setId(id);
                }
    ...
    public StringBuilder afficheAppart(ResultSet rs) throws SQLException {    //cette procédure permet l'affiche de deux demandes du controleur -> afficheALl et afficheRqst
        ...
        if(rs != null){
            ...
            System.out.println("Aucun appart trouvé");    //jeu de test, visuel dans le terminal
            textArea.setText("Aucun appart trouvé");
        }
        return sb;
    }
    ...
    private String getBoolAffichage() { return this.bool.toString();}


    ///////////////////SETTERS/////////////////////
    public void setBoolAffiche(String bool){this.bool = bool;}
